package ru.mirea.lukyanchuk.practice5;
...
public class MainActivity extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // создание списка для отображения в ListView найденных датчиков
        ...
        // создание адаптера и установка его типа (отображение двух полей)
